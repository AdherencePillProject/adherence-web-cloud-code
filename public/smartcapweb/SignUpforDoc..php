...
$nameErr = $emailErr = $genderErr = $PasswordErr =$confirmErr=$IDErr=$addressErr = $hospitalErr="";
$name = $email = $gender = $ID = $password =$confirm=$address =$hospital ="";
...
//gender post
   ...
   $signup =<<<EOF
      INSERT INTO doctor (doctor_id,doctor_name,hospital,doctor_password)
      VALUES ('$ID', '$name','$hospital','$confirm');
EOF;
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
  ...
  Address: <input type="text" name="address" value="<?php echo $address;?>">
   ...
   <br><br>
  Hospital: <input type="text" name="hospital" value="<?php echo $hospital;?>">
...
<!-- footer -->
		...
		<footer>
			<div class="wrapper">
				<a href="index.php" id="footer_logo"><span>Smart</span>Cap</a>
				<ul id="icons">
